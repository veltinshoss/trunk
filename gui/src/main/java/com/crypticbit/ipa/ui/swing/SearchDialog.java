...
public class SearchDialog extends JDialog {
	...
	private TextSearchPanel textSearchPanel = new TextSearchPanel();
	...
	public SearchDialog(final JFrame mainFrame, final Mediator mediator) {
		...
		// remove location search as currently unused and untested
		...
		getContentPane().add(textSearchPanel, BorderLayout.CENTER);
		...
		b.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				try {
					...
					SearchDialog.this.results = textSearchPanel
							.search(backupDir);
