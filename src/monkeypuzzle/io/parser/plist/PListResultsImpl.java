...
import monkeypuzzle.io.parser.plist.PListContainer.LeafVisitor;
		...
		PListResults<T>
{
	...
	{
		return matcher.match(this.bfd, this.root);
	}
			...
			final String searchString)
	{
		...
		this.root.visitLeafs(new PListLocation(this.bfd), new LeafVisitor() {
			@Override
