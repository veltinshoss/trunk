...
public class MediaParser implements BackupFileParser<ParsedData> {
	...
	public <I> I getContentbyInterface(final Class<I> interfaceDef) {
		...
		return (I) new MetadataImpl(metadata, new FileOnlyLocation(
			getBackupFile(), ContentType.IMAGE));
	    else
	...
	public String getSummary() {
	    return "media image: "
		    + MediaParser.this.bfd.getCompleteOriginalFileName();
	}
	...
	private String init() {
		...
		for(Directory directory : this.metadata
			.getDirectories())
