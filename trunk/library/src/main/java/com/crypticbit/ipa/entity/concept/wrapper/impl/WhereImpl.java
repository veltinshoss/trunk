...
public class WhereImpl implements GeoLocation, WhereTag.GeoSetter
{
	...
	{
		// comes in as Double but never has any decimal component AFAIK, so
		// converting to int for efficientcy and better display
	...
	public String toString()
	{
		...
		{
			return Double.valueOf(twoDecimalPlacesFormat.format(longitude))
					+ ","
					+ Double.valueOf(twoDecimalPlacesFormat.format(latitude))
					+ (altitude == null ? "" : " @" + altitude + "m high")
