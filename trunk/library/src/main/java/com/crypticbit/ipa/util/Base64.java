...
public final class Base64
{
	 ...
	 */
	private static final byte[] DECODABET = { -9, -9, -9, -9, -9, -9, -9, -9,
			-9, // Decimal 0 - 8
			...
			final int len)
	{
		...
		for (i = off; i < off + len; i++)
		{
			...
			{
				LogFactory.getLogger().log(Level.WARNING,"Bad Base64 input character at " + i + ": "
						+ source[i] + "(decimal)");
				return null;
			} // end else:
	...
	public static byte[] decodeFromFile(final String filename)
	{
		...
		{
			LogFactory.getLogger().log(Level.WARNING,"Error decoding from file " + filename);
	...
	public static String encodeFromFile(final String filename)
	{
		...
		{
			LogFactory.getLogger().log(Level.WARNING,"Error encoding from file " + filename);
		} // end catch: IOException
		finally
		{
			try
			...
			final byte[] destination, final int destOffset)
	{
		...
		else
		{
			...
			{
				LogFactory.getLogger().log(Level.WARNING,"" + source[srcOffset] + ": "
						+ (DECODABET[source[srcOffset]]));
				LogFactory.getLogger().log(Level.WARNING,"" + source[srcOffset + 1] + ": "
						+ (DECODABET[source[srcOffset + 1]]));
				LogFactory.getLogger().log(Level.WARNING,"" + source[srcOffset + 2] + ": "
						+ (DECODABET[source[srcOffset + 2]]));
				LogFactory.getLogger().log(Level.WARNING,"" + source[srcOffset + 3] + ": "
