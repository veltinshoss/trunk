...
import monkeypuzzle.central.backupfile.EncodedBackupFile;
import monkeypuzzle.central.backupfile.RemoteBackupFile;
...
import monkeypuzzle.licence.LicenceValidator;
...
public class IPhoneFactory
{
			...
			throws IOException
	{
		...
		this.tempDir = monkeypuzzle.io.util.IoUtils.createTempDir(".working");
	}
	 ...
	 */
	public IPhone createIPhoneState(final File directory)
			throws IPhoneParseException, IOException, FileParseException,
			NotLicencedException
	{
		IPhone iphone = new BackupDirectoryParser(this, directory,
